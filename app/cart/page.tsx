...
import { cartTotal, formatJOD, readCart, readNotes, removeFromCart, setQty, whatsappMessageForCart, writeNotes, writeCart } from "@/lib/cart";
        ...
        {items.length === 0 ? (
          ...
          <Card className="p-4">
            <div className="grid gap-3">
              {items.map((it) => (
                <div key={it.slug} className="flex items-center justify-between gap-3 rounded-2xl border border-black/10 p-3 dark:border-white/10">
                  <div>

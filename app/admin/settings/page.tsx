...
export default function AdminSettings() {
  ...
  const [branding, setBranding] = useState<Branding>({
    logoUrl: "",
    theme: { primary: "#111827", secondary: "#0ea5e9" },
  });
        ...
        <Card className="p-5">
          ...
          <div className="mt-3 grid gap-2">
            <Input
              ...
              placeholder="Logo URL (auto-filled if you upload)"
            />
            ...
            <Input
              ...
              onChange={(e) => setBranding({ ...branding, theme: { ...(branding.theme ?? {}), primary: e.target.value } })}
              placeholder="Primary color (hex)"
            />
            <Input
              value={branding.theme?.secondary ?? ""}
              onChange={(e) => setBranding({ ...branding, theme: { ...(branding.theme ?? {}), secondary: e.target.value } })}

          ...
          <div className="mt-3 grid gap-2">
            ...
            <div className="grid gap-2">
              <Input
                ...
                onChange={(e) => setCur({ ...cur, images: e.target.value.split(",").map((s) => s.trim()).filter(Boolean) })}
              ...
              />
              <p className="text-xs text-black/60">Create a PUBLIC Supabase bucket named <b>product-images</b>.</p>
            </div>
